...
namespace constants {
    ...
    namespace swerve {
        ...
        const WheelConstants frontRight = {"Front Right", 1, 5, { 0.476,  0.476}, {{0.7, 0, 0},  (-90.0 * M_PI / 180.0)}, 10};
        const WheelConstants backLeft   = {"Back Left",   3, 7, {-0.476, -0.476}, {{0.7, 0, 0},  (-90.0 * M_PI / 180.0)}, 12};
